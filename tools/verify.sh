...
step "9/60  Saved abilities survive a restart"
...
step "10/60  Death with no checkpoint banked"
...
step "12/60  Pause actually pauses"
...
step "13/60  Progression survives a room change"
...
step "14/60  No node leak across many room changes"
...
step "15/60  Wall jump is real content"
...
step "16/60  Charge attack is a mechanic, not a flag"
...
step "17/60  Environmental hazards exist"
...
step "18/60  Save survives a long session"
...
step "19/60  State machine survives input mashing"
...
step "20/60  Wall slide, the state mashing cannot reach"
...
step "21/60  Combo window escalates and lapses"
...
step "22/60  Sounds are actually distinguishable"
...
step "23/60  Falling out of the level kills and recovers"
...
step "25/60  Dash invulnerability"
...
step "26/60  Camera follows the player"
...
step "27/60  Checkpoints do not re-announce"
...
step "28/60  Enemies that fall out are removed"
...
step "29/60  No redundant ability pickups"
...
step "30/60  Nothing leaves the movement plane"
...
step "31/60  The run has an ending"
...
step "33/60  Enemies can be told apart by behaviour"
...
step "34/60  The three enemy types across a whole run"
...
step "35/60  Enemies are a threat, and the opening is survivable"
...
step "36/60  The whole run can actually be played"
...
step "37/60  Wall jumps actually climb"
...
step "38/60  Individual chunks at full difficulty"
...
step "39/60  Continuing animations loop"
...
step "40/60  Finishing the run leads somewhere"
...
step "41/60  Every checkpoint stands on ground"
...
step "42/60  The model is still moving seconds later"
...
step "43/60  Attacks can be seen coming"
...
step "44/60  Parry, and perfect parry"
...
step "45/60  The dead are cleaned up"
...
step "46/60  The voice pool recycles"
...
step "47/60  A long run WITH A RENDERER stays quiet"
...
step "48/60  The dungeon is not silent"
...
step "49/60  The pause menu is in the game"
...
step "50/60  The game boots into a title"
...
step "51/60  The last room is a boss fight"
...
step "52/60  Blows leave a mark, and absorbed ones look different"
...
step "53/60  Keys can be rebound, and one key means one action"
...
step "54/60  Enemies face what they are attacking"
...
step "55/60  The floor has an underside, and no hole is dark"
...
step "56/60  An arena cannot be run past"
...
step "57/60  Enemies hold the ground they were placed on"
...
step "58/60  The game exports and starts as a binary"
...
step "59/60  Continue continues, and a new run is new"
