...
step "9/61  Saved abilities survive a restart"
...
step "10/61  Death with no checkpoint banked"
...
step "12/61  Pause actually pauses"
...
step "13/61  Progression survives a room change"
...
step "14/61  No node leak across many room changes"
...
step "15/61  Wall jump is real content"
...
step "16/61  Charge attack is a mechanic, not a flag"
...
step "17/61  Environmental hazards exist"
...
step "18/61  Save survives a long session"
...
step "19/61  State machine survives input mashing"
...
step "20/61  Wall slide, the state mashing cannot reach"
...
step "21/61  Combo window escalates and lapses"
...
step "22/61  Sounds are actually distinguishable"
...
step "23/61  Falling out of the level kills and recovers"
...
step "25/61  Dash invulnerability"
...
step "26/61  Camera follows the player"
...
step "27/61  Checkpoints do not re-announce"
...
step "28/61  Enemies that fall out are removed"
...
step "29/61  No redundant ability pickups"
...
step "30/61  Nothing leaves the movement plane"
...
step "31/61  The run has an ending"
...
step "33/61  Enemies can be told apart by behaviour"
...
step "34/61  The three enemy types across a whole run"
...
step "35/61  Enemies are a threat, and the opening is survivable"
...
step "36/61  The whole run can actually be played"
...
step "37/61  Wall jumps actually climb"
...
step "40/61  Finishing the run leads somewhere"
...
step "41/61  Every checkpoint stands on ground"
...
step "42/61  The model is still moving seconds later"
...
step "43/61  Attacks can be seen coming"
...
step "44/61  Parry, and perfect parry"
...
step "45/61  The dead are cleaned up"
...
step "46/61  The voice pool recycles"
...
step "47/61  A long run WITH A RENDERER stays quiet"
...
step "48/61  The dungeon is not silent"
...
step "49/61  The pause menu is in the game"
...
step "50/61  The game boots into a title"
...
step "51/61  The last room is a boss fight"
...
step "52/61  Blows leave a mark, and absorbed ones look different"
...
step "53/61  Keys can be rebound, and one key means one action"
...
step "54/61  Enemies face what they are attacking"
...
step "55/61  The floor has an underside, and no hole is dark"
...
step "56/61  An arena cannot be run past"
...
step "57/61  Enemies hold the ground they were placed on"
...
step "58/61  The game exports and starts as a binary"
...
step "59/61  Continue continues, and a new run is new"
...
step "60/61  There is music, and it moves"
